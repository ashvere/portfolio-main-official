/* ========================================================================
   CircularGallery — vanilla ES module port of the React Bits <CircularGallery />
   component (https://reactbits.dev), for use without React or a bundler.
   OGL has no browser-ready UMD build, so it's imported from esm.sh here.
   ======================================================================== */
    ...
    try {
        ...
        if (document.fonts && document.fonts.load) {
            try {
                ...
                // Ignore - still attempt to render with the requested font.
            }
        }
        return resolved;
    } catch (error) {
...
export async function createCircularGallery(
    container,
